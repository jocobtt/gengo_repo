...
def find_train_route(start, goal, skip_cache, open_browser, google_maps):
    start_address = get_cache(start) if not skip_cache else None
    if start_address is None:
        start_candidates = address_search(start)
        # need to make sure that I am selecting it to not include car instructions 
    ...
    if goal_address is None:
        ...
        goal_address = address_choice(start_candidates, "Choose a destination address:")
